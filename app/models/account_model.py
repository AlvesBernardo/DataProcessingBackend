...
class Account(db.Model):
    ...
    isAccountBlocked = db.Column(db.Boolean, nullable=False,
                                 default=False)  # Use 'isAccountBlocked' instead of 'dtIsAccountBlocked'
    dtIsAdmin = db.Column(db.Boolean, nullable=False, default=False)
    fiSubscription = db.Column(db.Integer,
                               db.ForeignKey("[dbo].tblSubscription.idSubscription"))  # Adjust relationship names
